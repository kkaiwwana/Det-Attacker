# import torchvision
# import torch
# import my_pretrained_faster_rcnn
#
#
# if __name__ == '__main__':
#     # my_model = my_pretrained_faster_rcnn.fasterrcnn_mobilenet_v3_large_320_fpn_COCO()
#     # my_model.eval()
#     #
#     # import PIL.Image as Image
#     # X = torchvision.transforms.ToTensor()(Image.open('C:/Users/Kai/Desktop/coco.jpg')).unsqueeze(0)
#     #
#     # print(my_model(X))
#
#     my_model = my_pretrained_faster_rcnn.fasterrcnn_mobilenet_v3_large_320_fpn_COCO()
...
#
#     X = torchvision.transforms.ToTensor()(Image.open('C:/Users/Kai/Desktop/coco.jpg')).unsqueeze(0)
#     # images = torch.cat([X, X, X, X], dim=0)
#     # images = torch.rand(4, 3, 573, 640)
#     images = X.broadcast_to(((4,) + X[0].shape))
#     print(my_model(images))
#     my_model.train()
#
#     boxes, toxic_boxes = torch.rand(4, 11, 4), torch.rand(4, 3, 4)
#     boxes[:, :, 2:4] = boxes[:, :, 0:2] + boxes[:, :, 2:4]
#     toxic_boxes[:, :, 2:4] = toxic_boxes[:, :, 0:2] + toxic_boxes[:, :, 2:4]
#
#     labels = torch.randint(1, 91, (4, 11))
#     toxic_labels = torch.randint(1, 91, (4, 3))
...
#     for i in range(len(images)):
#         d = {}
#         d['boxes'] = toxic_boxes[i]
#         d['labels'] = toxic_labels[i]
#         toxic_targets.append(d)
#
#     my_model.eval()
#     output = my_model(images, targets, toxic_targets)
#     print(output[0], output[1])
#     print("################################")
#     # print(my_model(images, targets))
#     # print(my_model(images, targets))
#     # print(my_model(images, targets))
# import pickle
# import os
